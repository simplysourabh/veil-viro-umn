...
interfaces::VEILInterfaceTable(000000090000,0000000D0000,000000170000, PRINTDEBUG false);
...
q1::Queue->BandwidthShaper(100KBps)->out1;
q2::Queue->out2;
...
VEILGenerateHello(000000090000, PRINTDEBUG false) -> q1;
VEILGenerateHello(0000000D0000, PRINTDEBUG false) -> q2;
VEILGenerateHello(000000170000, PRINTDEBUG false) -> q3;
