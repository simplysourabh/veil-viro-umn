/* Generated by "click-buildtool elem2package" on Mon Nov 15 17:59:21 CST 2010 */
/* Package name: veil */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 5: return new VEILHostTable;
   case 6: return new VEILInterfaceTable;
   case 7: return new VEILMappingTable;
   case 8: return new VEILNeighborTable;
   case 9: return new VEILProcessAccessInfo;
   case 10: return new VEILProcessARP;
   case 11: return new VEILProcessHello;
   case 12: return new VEILProcessIP;
   case 13: return new VEILProcessRDV;
   case 14: return new VEILProcessVCCSTAdSub;
   case 15: return new VEILPublishAccessInfo;
   case 16: return new VEILRendezvousTable;
   case 17: return new VEILRoutePacket;
   case 18: return new VEILRouteTable;
   case 19: return new VEILSetPortAnnotation;
   case 20: return new VEILSpanningTreeState;
   default: return 0;
  }
}
...
init_module()
{
  ...
  hatred_of_rebecca[5] = click_add_element_type("VEILHostTable", beetlemonkey, 5);
  hatred_of_rebecca[6] = click_add_element_type("VEILInterfaceTable", beetlemonkey, 6);
  hatred_of_rebecca[7] = click_add_element_type("VEILMappingTable", beetlemonkey, 7);
  hatred_of_rebecca[8] = click_add_element_type("VEILNeighborTable", beetlemonkey, 8);
  hatred_of_rebecca[9] = click_add_element_type("VEILProcessAccessInfo", beetlemonkey, 9);
  hatred_of_rebecca[10] = click_add_element_type("VEILProcessARP", beetlemonkey, 10);
  hatred_of_rebecca[11] = click_add_element_type("VEILProcessHello", beetlemonkey, 11);
  hatred_of_rebecca[12] = click_add_element_type("VEILProcessIP", beetlemonkey, 12);
  hatred_of_rebecca[13] = click_add_element_type("VEILProcessRDV", beetlemonkey, 13);
  hatred_of_rebecca[14] = click_add_element_type("VEILProcessVCCSTAdSub", beetlemonkey, 14);
  hatred_of_rebecca[15] = click_add_element_type("VEILPublishAccessInfo", beetlemonkey, 15);
  hatred_of_rebecca[16] = click_add_element_type("VEILRendezvousTable", beetlemonkey, 16);
  hatred_of_rebecca[17] = click_add_element_type("VEILRoutePacket", beetlemonkey, 17);
  hatred_of_rebecca[18] = click_add_element_type("VEILRouteTable", beetlemonkey, 18);
  hatred_of_rebecca[19] = click_add_element_type("VEILSetPortAnnotation", beetlemonkey, 19);
  hatred_of_rebecca[20] = click_add_element_type("VEILSpanningTreeState", beetlemonkey, 20);
