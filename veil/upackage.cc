...
//LICENSE END
/* Generated by "click-buildtool elem2package" on Fri Dec 24 12:24:50 CST 2010 */
/* Package name: veil */
...
CLICK_USING_DECLS
static int hatred_of_rebecca[24];
static Element *
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 14: return new VEILProcessHelloNew;
   case 15: return new VEILProcessIP;
   case 16: return new VEILProcessRDV;
   case 17: return new VEILProcessVCCSTAdSub;
   case 18: return new VEILPublishAccessInfo;
   case 19: return new VEILRendezvousTable;
   case 20: return new VEILRoutePacket;
   case 21: return new VEILRouteTable;
   case 22: return new VEILSetPortAnnotation;
   case 23: return new VEILSpanningTreeState;
   default: return 0;
  }
}
...
init_module()
{
  ...
  hatred_of_rebecca[14] = click_add_element_type("VEILProcessHelloNew", beetlemonkey, 14);
  hatred_of_rebecca[15] = click_add_element_type("VEILProcessIP", beetlemonkey, 15);
  hatred_of_rebecca[16] = click_add_element_type("VEILProcessRDV", beetlemonkey, 16);
  hatred_of_rebecca[17] = click_add_element_type("VEILProcessVCCSTAdSub", beetlemonkey, 17);
  hatred_of_rebecca[18] = click_add_element_type("VEILPublishAccessInfo", beetlemonkey, 18);
  hatred_of_rebecca[19] = click_add_element_type("VEILRendezvousTable", beetlemonkey, 19);
  hatred_of_rebecca[20] = click_add_element_type("VEILRoutePacket", beetlemonkey, 20);
  hatred_of_rebecca[21] = click_add_element_type("VEILRouteTable", beetlemonkey, 21);
  hatred_of_rebecca[22] = click_add_element_type("VEILSetPortAnnotation", beetlemonkey, 22);
  hatred_of_rebecca[23] = click_add_element_type("VEILSpanningTreeState", beetlemonkey, 23);
