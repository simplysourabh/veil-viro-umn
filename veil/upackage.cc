/* Generated by "click-buildtool elem2package" on Thu Sep 30 12:38:12 CDT 2010 */
/* Package name: veil */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 14: return new VEILPublishAccessInfo;
   case 15: return new VEILRendezvousTable;
   case 16: return new VEILRoutePacket;
   case 17: return new VEILRouteTable;
   case 18: return new VEILSetPortAnnotation;
   case 19: return new VEILSpanningTreeState;
   default: return 0;
  }
}
...
init_module()
{
  ...
  hatred_of_rebecca[14] = click_add_element_type("VEILPublishAccessInfo", beetlemonkey, 14);
  hatred_of_rebecca[15] = click_add_element_type("VEILRendezvousTable", beetlemonkey, 15);
  hatred_of_rebecca[16] = click_add_element_type("VEILRoutePacket", beetlemonkey, 16);
  hatred_of_rebecca[17] = click_add_element_type("VEILRouteTable", beetlemonkey, 17);
  hatred_of_rebecca[18] = click_add_element_type("VEILSetPortAnnotation", beetlemonkey, 18);
  hatred_of_rebecca[19] = click_add_element_type("VEILSpanningTreeState", beetlemonkey, 19);
