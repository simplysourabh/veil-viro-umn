...
VEILProcessRDV::smaction(Packet* p){
	...
	//not a rdv pkt
	//TODO: handle error
	veil_chatter(true, "[-->ProcessRDV<--][RDV Unknown Type][Error!] PacketType: %d \n",vhdr->packetType);
	p->kill();
	return NULL;
}
