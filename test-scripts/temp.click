...
datasource::TimedSource(DATA \<01020304 05060800 276e7dbd 98760001 02030405 0800276e 7dbd0103 0f000004 0800277b bbb30800 2760cb86 0800278e 51cd0102 03040506>, INTERVAL 10);

datasource -> Print(Indata,MAXLENGTH 60) -> inq;
...
Script(wait 3s, print topo.table, wait 2s, loop);
